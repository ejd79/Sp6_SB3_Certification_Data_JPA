...
public interface ProductRepository extends JpaRepository<Product, Long> {
     ...
     * criteria. If not product entry is found, this method return null.
     *
     * @param name
     * @return Product
     */
    ...
    /**
     * Return the found list of product entries whose title or description is given
    ...
    /**
     * Return the found list of product entries whose title and description is given
     * as a method parameter. If no product entries is found, this method
     * returns an empty list.
     *
     * @param name
